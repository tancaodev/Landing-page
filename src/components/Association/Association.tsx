...
const Association = () => {
    return (
        <div className='w-full bg-white mt-6 md:mt-8 lg:mt-10'>
            <div className='w-full text-center px-4 md:px-8 lg:mx-auto'>
            ...
            <div className='flex flex-col justify-center min-[90rem]:flex-row gap-4 md:gap-6 lg:gap-12 mt-6 md:mt-8 lg:mt-12 px-4 md:px-8 lg:mx-36'>
